...
class HelpScreenState extends State<HelpScreen> {
  ...
  _loadHtmlFromAssets() async {
    String fileText = await rootBundle.loadString('assets/html/info.html');
...
class Html extends StatelessWidget{
  ...
  var HtmlCode = '<html><body>'+contenido.toString()+'</body></html>';
    return Scaffold(
      appBar: AppBar(title: Text(titulo),backgroundColor:const Color.fromARGB(255,147,26,43) ,),
      body: WebView(
          initialUrl: Uri.dataFromString( HtmlCode, mimeType: 'text/html',encoding: Encoding.getByName('utf-8') ).toString()
          )
